...
public class controller {
	...
	public void Login (ActionEvent e) throws IOException {
		...
		if(found) {
			...
			FXMLLoader loader3 = new FXMLLoader(getClass().getResource("/application/LoginSuccess1.fxml"));
			root = loader3.load();
	...
	public void Register (ActionEvent e) throws IOException{
		...
		FXMLLoader loader = new FXMLLoader(getClass().getResource("/application/RegisterScene1.fxml"));
		root = loader.load();
		stage = (Stage)((Node)e.getSource()).getScene().getWindow();
		scene = new Scene (root);
		...
		//check whether contain commas
			...
			if(exist) {
				...
				if(password.equals(comPass)) {
					try {
						tulis.write(nama+","+user+","+password+"\n");
						tulis.close();
